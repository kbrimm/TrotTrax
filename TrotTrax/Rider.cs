...
namespace TrotTrax
{
    class Rider : ListObject
    {
        ...
        public Rider(string clubID, int year)
        {
            ...
            riderList = database.GetRiderItemList(clubID, year, "rider_name");
        ...
        public Rider(string clubID, int year, int riderNo)
        {
            ...
            firstName = database.GetValueString(clubID, year + "_rider", "rider_first", "rider_no = " + riderNo);
            lastName = database.GetValueString(clubID, year + "_rider", "rider_last", "rider_no = " + riderNo);
